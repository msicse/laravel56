    ...
    <head>
       ...
       <!--  <link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/css/toastr.min.css"> -->
        ...
        <style>
            ...
            {
                background: url('{{ asset('uploads/slider/'.$data->image)  }}');
            ...
            <div class="item">
                <div class="container">
                    <div class="header-content">
                        ...
                        <p class="header-sub-title"> {{ $data->sub_title }} </p>
                    </div> <!-- /.header-content -->
                </div>
            </div>
            @endforeach  
                    ...
                    <div class=" section-content">
                        <div class="row">
                            <div class="col-md-5 col-sm-6">
                                <form class="reservation-form" method="post" action="{{ route('reserved') }}">
                                    @csrf
                                    <div class="row">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1">
                        <div class="row">
                             <form class="contact-form" method="post" action="{{ route('contacts.sendmessage') }}">
                                @csrf
                                <div class="col-md-6 col-sm-6">
                                    <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <div class="copyright text-center">
                            <p>
                                &copy; Copyright, 2018 <a href="#"></a> Theme by <a href="#"  target="_blank">Sumon</a>
                            </p>
                        </div>
                    </div>
                </div>
